          ...
          {isLoading ? (
            ...
            <div className="resources-grid">
              ...
              <div className="resource-card">
                ...
                <div className="resource-info">
                  <h3>Thêm vật tư vào kho</h3>
                  <p className="resource-date">Xem khai báo thuốc từ phụ huynh</p>
                  <Link to="/themvattu" className="btn btn-sm">
                    Xem chi tiết
                  </Link>
                </div>
              </div>
              ...
              <div className="resource-card">
                ...
                <div className="resource-info">
                  <h3>Quản Lý </h3>
                  <p className="resource-date">Quản lý kho thuốc và vật tư</p>
                  <Link to="/quanlyvattuyte" className="btn btn-sm">
                    Quản lý
                  </Link>
                </div>
              </div>
