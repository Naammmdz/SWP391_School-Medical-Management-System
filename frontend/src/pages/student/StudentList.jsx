...
import {
    Card, Input, Button, Alert, Spin, Typography, Space, Row, Col, Table, Tag, Select, Modal, Tooltip, message, Avatar
} from 'antd';
import {
    UserOutlined,
    SearchOutlined,
...
const genderOptions = [{value: '', label: 'Giới tính'}, {value: 'Nam', label: 'Nam'}, {value: 'Nữ', label: 'Nữ'}];
...
const StudentList = () => {
    ...
    const [filter, setFilter] = useState({
        fullName: '', className: '', gender: '', parentName: ''
    });
    ...
    // Get parent phone from users list
    ...
    return (<div style={{
        maxWidth: 1200, margin: '0 auto', padding: '24px', backgroundColor: '#f0f2f5', minHeight: '100vh'
    }}>
        {/* Header */}
        <Row justify="space-between" align="middle" style={{
            ...
            <Col>
                <Space direction="vertical" size={4}>
                    <Title level={2} style={{
                        margin: 0, color: '#15803d', fontSize: 28, fontWeight: 600
                    }}>
        ...
        <Card
            style={{
                marginBottom: 24, borderRadius: 16, boxShadow: '0 2px 12px rgba(0,0,0,0.08)', border: 'none'
            }}
        ...
        >
            <Space direction="vertical" size={20} style={{width: '100%'}}>
                <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
                    <Title level={4} style={{
                        margin: 0, color: '#262626', fontSize: 18, fontWeight: 600
                    }}>
                    ...
                    <Col xs={24} sm={12} md={6}>
                        <Space>
                            <Button
                                ...
                                style={{
                                    borderRadius: 8, background: '#fff', borderColor: '#d9d9d9', color: '#595959'
                                }}
                                size="large"
                            >
                                Xóa bộ lọc
        ...
        <Card
            style={{
                borderRadius: 16, boxShadow: '0 2px 12px rgba(0,0,0,0.08)', border: 'none', overflow: 'hidden'
            }}
            bodyStyle={{padding: 0}}
        >
            <div style={{
                padding: '20px 24px', borderBottom: '1px solid #f0f0f0', background: '#fafafa'
            }}>
                <Title level={4} style={{
                    margin: 0, color: '#262626', fontSize: 18, fontWeight: 600
                }}>
            ...
            <Table
                ...
                columns={[{
                    title: 'Họ và tên', dataIndex: 'fullName', key: 'fullName', render: (text) => (<Space>
                        <Avatar
                            size="small"
                    ...
                    dataIndex: 'dob',
                    key: 'dob',
                    render: (date) => (<span style={{color: '#595959'}}>
                  <CalendarOutlined style={{marginRight: 4, color: '#8c8c8c'}}/>
                        {formatDate(date)}
                </span>)
                }, {
                    title: 'Giới tính', dataIndex: 'gender', key: 'gender', render: (gender) => {
                    ...
                    title: 'Lớp', dataIndex: 'className', key: 'className', render: (className) => (<Tag
                        color="green"
                        style={{
                    ...
                    dataIndex: 'parentId',
                    key: 'parentId',
                    render: (parentId) => (<span style={{color: '#595959'}}>
                  ...
                  <PhoneOutlined style={{marginRight: 4, color: '#8c8c8c'}}/>
                    ...
                    title: 'Hành động', key: 'action', render: (text, record) => (<Space size="middle">
                ...
                pagination={{
                    ...
                    showTotal: (total, range) => (<span style={{color: '#595959'}}>
