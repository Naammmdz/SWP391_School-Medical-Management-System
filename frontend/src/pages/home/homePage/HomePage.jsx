        ...
        <div className="container">
          ...
          <div className="intro-content">
            <div className="intro-text">
              <p>
              Trường Tiểu học FPT là một thành viên của Tổ chức Giáo dục FPT, hướng đến xây dựng môi trường học tập hiện đại, thân thiện và sáng tạo. Trường áp dụng chương trình giáo dục tích hợp giữa chuẩn quốc gia và các môn học nâng cao như Tiếng Anh, STEM, Kỹ năng sống, giúp học sinh phát triển toàn diện về trí tuệ, thể chất và cảm xúc.
